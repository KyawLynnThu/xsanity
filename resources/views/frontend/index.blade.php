...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="{{asset('frontend_assets/images/11.jpg')}}" alt="" />
			...
			<li>
				<img src="{{asset('frontend_assets/images/22.jpg')}}" alt="" />
				  <div class="slide-desc">
			...
			<li>
				<img src="{{asset('frontend_assets/images/44.jpg')}}" alt="" />
				<div class="slide-desc">
					<h3>Whole Spices Products Are Now On Line With Us</h3>
				</div>
			</li>
									...
									<div class="hover14 column">
										<div class="agile_top_brand_left_grid">
											<div class="agile_top_brand_left_grid_pos">
												{{-- <img src="{{'storage/'.$item->photo}}" alt="" style="height: 100px;" /> --}}
											</div>
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="products.html"><img title=" " alt=" " src="{{'storage/'.$item->photo}}" style="height: 100px;" /></a>		
															<p>{{$item->name}}</p>
															<div class="stars">
