...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('category.index')}}" class="brand-link">
      ...
      <h1 class="brand-text" style="text-align: center; color: #FF0000">XSANITY</h1>
      <h6 class="brand-text font-weight-light" style="text-align: center; color: #FF0000;">Great Services, Great Values</h6>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="{{route('user.edit',Auth::user()->id)}}" class="d-block" style="text-transform: uppercase;" >{{ Auth::user()->name }}</a>
        </div>
      </div>
